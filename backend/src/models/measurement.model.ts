...
const measurementSchema = new mongoose.Schema<Measurement>(
  {
    ...
    frontPocket: { type: Boolean, required: [true, "Front pocket is required"] }, // Front pocket is whether the kameez should have a front pocket
    ...
    sidePockets: { type: Boolean, required: [true, "Side pockets is required"] }, // Side pockets is whether the kameez should have side pockets single, double, none
    ...
    sleeveType: { type: Boolean, required: [true, "Sleeve type is required"] }, // Sleeve type single or double
